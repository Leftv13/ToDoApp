...
//     if (!navbar) {
//         console.error('Elemento #navbar no encontrado. Verifica tu HTML.');
//         return; // Detiene la ejecución si navbar no existe
//     }

//     // ... (Mantén las funciones setupCommonEventListeners y setupLogoutEventListeners tal como están) ...
...
//                                 </svg>
//                                 <div class="bg-slate-900/80 fixed top-16 right-0 left-0 bottom-0 flex justify-center items-center flex-col gap-4 hidden">
//                                     <button id="close-btn" class="logout-btn-mobile transition ease-in-out text-white font-bold bg-indigo-500 hover:bg-indigo-800 py-2 px-4 rounded-lg">Cerrar Sesion</button>
//                                 </div>
//                                 <div class="hidden md:flex flex-row gap-4">
//                                     <button id="close-btn" class="logout-btn-desktop transition ease-in-out text-white font-bold bg-indigo-500 hover:bg-indigo-800 py-2 px-4 rounded-lg">Cerrar Sesion</button>
//                                 </div>
//                             </div>`;
//         setupCommonEventListeners();
...
//     // Lógica de enrutamiento para crear la navbar adecuada
...
//         createNavLogin();
//     } else if (window.location.pathname.includes('/todos')) {
//         createNavTodos();
//     } else {
//         console.warn(`No se encontró una configuración de navbar para la ruta: ${window.location.pathname}`);
//     }
// });
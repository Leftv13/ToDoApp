...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const createNavTodos = () => {
        navbar.innerHTML = `<div class="max-width-7xl h-16 mx-auto flex items-center px-4 justify-between">
                                ...
                                <div class="bg-slate-900/80 fixed top-16 right-0 left-0 bottom-0 flex justify-center items-center flex-col gap-4 hidden">
                                    <button class="logout-btn-mobile transition ease-in-out text-white font-bold bg-indigo-500 hover:bg-indigo-800 py-2 px-4 rounded-lg">Cerrar Sesion</button>
                                </div>
                                <div class="hidden md:flex flex-row gap-4">
                                    <button class="logout-btn-desktop transition ease-in-out text-white font-bold bg-indigo-500 hover:bg-indigo-800 py-2 px-4 rounded-lg">Cerrar Sesion</button>
                                </div>
                            </div>`;
        setupCommonEventListeners();
